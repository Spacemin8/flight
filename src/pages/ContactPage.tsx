...
export default function ContactPage() {
  ...
  const contactSchema = {
    ...
    description:
      'Kontaktoni Hima Travel për bileta avioni me çmimet më të mira. Rezervoni fluturime direkte dhe me ndalesë për destinacionet tuaja të preferuara.',
    ...
    hasMap:
      'https://www.google.com/maps/place/Hima+Travel+Agjensi+Udhetimi+%26+Turistike+-+Bileta+Avioni+Tirane',
    sameAs: [
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Jemi këtu për t'ju ndihmuar me çdo pyetje ose rezervim për bileta
              avioni
            </p>
          </div>
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600">
                    Tiranë, Tek kryqëzimi i Rrugës Muhamet Gjollesha me Myslym
                    Shyrin
                  </p>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 text-center">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">
              Kontaktoni me Ne për Bileta Avioni
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600">
                  Dërgoni kërkesën tuaj për bileta avioni dhe do t'ju
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600">
                  Telefononi për rezervime të menjëhershme të biletave të
                  avionit
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="font-medium text-gray-900 mb-2">
                    Si mund të rezervoj një biletë avioni?
                  </h4>
                  <p className="text-gray-600">
                    Mund të rezervoni bileta avioni duke na kontaktuar në
                    telefon, email, ose duke vizituar zyrat tona në Tiranë dhe
                    Durrës. Gjithashtu mund të përdorni platformën tonë online
                    për të kërkuar dhe rezervuar bileta.
                  </p>
                </div>

                <div className="bg-gray-50 rounded-lg p-4">
                  <h4 className="font-medium text-gray-900 mb-2">
                    Sa kohë përpara duhet të rezervoj biletën e avionit?
                  </h4>
                  <p className="text-gray-600">
                    Rekomandojmë të rezervoni bileta avioni 2-3 muaj përpara
                    udhëtimit për çmimet më të mira. Për sezonin e lartë (verë,
                    festat e fundvitit), është mirë të rezervoni 4-6 muaj
                    përpara.
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-gray-600">
                    Po, Hima Travel ofron garanci çmimi për bileta avioni. Nëse
                    gjeni të njëjtin fluturim me çmim më të ulët brenda 24 orëve
                    pas rezervimit, ne do të rimbursojmë diferencën.
                  </p>
                </div>
              </div>
            </div>
