/*
  # Fix Route Tracking System

  1. Changes
    - Remove references to route_update_settings
    - Update functions to use route_demand_tracking
    - Add update_interval and is_ignored to route_demand_tracking
...
-- Add update_interval and is_ignored columns if they don't exist
