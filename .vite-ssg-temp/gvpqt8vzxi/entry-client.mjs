    ...
    try {
      ...
      if (shouldRetry && retries < maxRetries) {
        ...
        if (error.message.includes("session_not_found") || error.message.includes("JWT expired")) {
          try {
            const { data: { session }, error: refreshError } = await supabase$1.auth.refreshSession();
...
setInterval(async () => {
  const { data: { session }, error } = await supabase$1.auth.getSession();
  if (session && !error) {
...
async function getCalendarPrices(origin, destination, yearMonth, tripType = "oneWay", isReturn = false) {
  ...
  try {
    ...
    if (!shouldUpdate && data) {
      ...
      for (const [date, price] of Object.entries(adjustedPrices2 || {})) {
        finalPriceGrid2[date] = {
          price: Number(price),
          isDirect: ((_a = data.price_grid[date]) == null ? void 0 : _a.isDirect) || false
        };
      }
      return {
        origin: data.origin,
    ...
    if (!((_b = responseData.data.PriceGrids) == null ? void 0 : _b.Grid)) {
...
function MobileDatePickerModal({
  ...
  const getTotalPrice = () => {
    ...
    if (departureDate) {
      ...
      total += ((_a = departurePrices[departureDateStr]) == null ? void 0 : _a.price) || 0;
    }
    if (tripType === "roundTrip" && returnDate) {
      const returnDateStr = format(returnDate, "yyyy-MM-dd");
      total += ((_b = returnPrices[returnDateStr]) == null ? void 0 : _b.price) || 0;
    }
    return total || null;
  };
  const getCurrentPrice = () => {
    ...
    if (selectingReturn && returnDate) {
      const returnDateStr = format(returnDate, "yyyy-MM-dd");
      return ((_a = returnPrices[returnDateStr]) == null ? void 0 : _a.price) || null;
    } else if (!selectingReturn && departureDate) {
      const departureDateStr = format(departureDate, "yyyy-MM-dd");
      return ((_b = departurePrices[departureDateStr]) == null ? void 0 : _b.price) || null;
    }
    return null;
  };
...
`;
      if (index < outboundFlights.length - 1 && ((_a = flight.layovers) == null ? void 0 : _a[index])) {
...
`;
        if (index < returnFlights.length - 1 && ((_a = flight.layovers) == null ? void 0 : _a[index + outboundFlights.length])) {
        ...
        /* @__PURE__ */ jsx("div", { className: "p-6", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row lg:items-start justify-between gap-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "lg:w-64 flex flex-col items-center gap-4 lg:border-l lg:border-gray-100 lg:pl-6", children: [
            /* @__PURE__ */ jsx(
              PriceSection,
              {
                basePrice: (_a = flight.price_breakdown) == null ? void 0 : _a.base_price,
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-[400px] flex flex-col items-center justify-center p-8", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "w-full max-w-md mb-8", children: progress !== void 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-2", children: MILESTONES.map((milestone, index) => {
        ...
        const isCurrent = ((_a = getCurrentMilestone()) == null ? void 0 : _a.percent) === milestone.percent;
        return /* @__PURE__ */ jsxs(
          "div",
          {
...
function FlightDetailModal({ isOpen, onClose, flightOption, searchParams }) {
  ...
  if (!isOpen) return null;
  if (!((_a = flightOption == null ? void 0 : flightOption.flights) == null ? void 0 : _a.length)) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 z-50 flex items-end md:items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "bg-white w-full md:rounded-xl md:max-w-3xl md:w-full max-h-[90vh] overflow-y-auto rounded-t-xl", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "sticky bottom-0 bg-white border-t border-gray-200 p-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
      /* @__PURE__ */ jsx(
        PriceSection,
        {
          basePrice: (_b = flightOption.price_breakdown) == null ? void 0 : _b.base_price,
          passengers: searchParams.passengers,
...
async function calculateFlightScore(flight) {
  ...
  const origin = (_a = flight.flights[0]) == null ? void 0 : _a.departure_airport.id;
  const destination = (_b = flight.flights[0]) == null ? void 0 : _b.arrival_airport.id;
...
function parseRapidApiResponse(response) {
  ...
  if (!((_a = response == null ? void 0 : response.data) == null ? void 0 : _a.itineraries)) {
...
function processLeg(leg) {
  ...
  leg.segments.forEach((segment, index) => {
    ...
    const flight = {
      ...
      airline_logo: ((_a = leg.carriers.marketing[0]) == null ? void 0 : _a.logoUrl) || `https://logos.skyscnr.com/images/airlines/favicon/${segment.marketingCarrier.alternateId}.png`,
...
function convertItineraryToFlightOption(itinerary) {
  ...
  try {
    ...
    const flightOption = {
      ...
      airline_logo: (_a = outbound.flights[0]) == null ? void 0 : _a.airline_logo,
...
function parseFlightApiResponse(response) {
  ...
  if (!((_a = response == null ? void 0 : response.itineraries) == null ? void 0 : _a.length)) {
  ...
  const flightOptions = response.itineraries.map((itinerary) => {
    ...
    try {
      ...
      const flightOption = {
        ...
        total_duration: totalDuration,
        price: ((_b = (_a2 = itinerary.pricing_options[0]) == null ? void 0 : _a2.price) == null ? void 0 : _b.amount) || 0,
  ...
  for (let attempt = 0; attempt <= MAX_RETRIES; attempt++) {
    try {
      ...
      if (axios.isAxiosError(err)) {
        if (err.code === "ECONNABORTED" || ((_a = err.response) == null ? void 0 : _a.status) === 429) {
          console.error("RapidAPI error (attempt " + (attempt + 1) + "):", err.message);
          if (attempt < MAX_RETRIES) continue;
          return null;
        }
        console.error("RapidAPI error:", ((_b = err.response) == null ? void 0 : _b.data) || err.message);
        if (attempt < MAX_RETRIES) continue;
        return null;
      }
  ...
  for (let attempt = 0; attempt <= MAX_RETRIES; attempt++) {
    try {
      ...
      const urlParts = [
        ...
        params.tripType === "roundTrip" ? (_a = params.returnDate) == null ? void 0 : _a.split("T")[0] : null,
      ...
      if (axios.isAxiosError(err)) {
        if (err.code === "ECONNABORTED" || ((_b = err.response) == null ? void 0 : _b.status) === 429) {
...
async function refreshFlightData(searchParams, batchId, onProgress) {
  ...
  const searchPromise = (async () => {
    ...
    try {
      ...
      if (!response || !((_a = response.best_flights) == null ? void 0 : _a.length) && !((_b = response.other_flights) == null ? void 0 : _b.length)) {
        return {
          best_flights: [],
          other_flights: []
        };
  ...
  return /* @__PURE__ */ jsx("footer", { className: `bg-white border-t border-gray-100 ${className}`, children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 py-12", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: (_a = groupedLinks["Popular"]) == null ? void 0 : _a.map((link, index) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(
          "a",
          {
            href: link.url,
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h4", { className: "text-gray-900 font-semibold mb-4", children: "Lidhje të Shpejta" }),
        /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: (_b = groupedLinks["Quick"]) == null ? void 0 : _b.map((link, index) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
          "a",
          {
            href: link.url,
...
function AdminLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const isAdmin = ((_a = userData.user.user_metadata) == null ? void 0 : _a.role) === "admin";
      if (!isAdmin) {
        await supabase$1.auth.signOut();
        throw new Error("Unauthorized access");
      }
...
function ManualApiSearch() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (!data.status || !((_b = (_a = data.data) == null ? void 0 : _a.PriceGrids) == null ? void 0 : _b.Grid)) {
      ...
      data.data.PriceGrids.Grid[0].forEach((dayData, index) => {
        ...
        } else if (((_a2 = dayData.Direct) == null ? void 0 : _a2.Price) > 0) {
          priceGrid[date] = {
            price: dayData.Direct.Price,
            isDirect: false
          };
        } else if (((_b2 = dayData.Indirect) == null ? void 0 : _b2.Price) > 0) {
          priceGrid[date] = {
            price: dayData.Indirect.Price,
            isDirect: false
          };
...
function AdminDocumentation() {
  ...
  const ActiveComponent = ((_a = SECTIONS.find((s) => s.id === activeSection)) == null ? void 0 : _a.component) || ModuleOverview;
  return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg shadow-md overflow-hidden", children: [
    /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 border-b border-gray-200", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "bg-white rounded-lg border border-gray-200 overflow-hidden", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [
      ...
      /* @__PURE__ */ jsx("tbody", { className: "bg-white divide-y divide-gray-200", children: paginatedConnections.map((connection) => {
        ...
        return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50", children: [
          ...
          /* @__PURE__ */ jsxs("td", { className: "px-6 py-4 whitespace-nowrap", children: [
            /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: ((_a = connection.template_type) == null ? void 0 : _a.name) || "Not Set" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "bg-white rounded-lg border border-gray-200 overflow-hidden", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [
      ...
      /* @__PURE__ */ jsx("tbody", { className: "bg-white divide-y divide-gray-200", children: paginatedPages.map((page) => {
        ...
        return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50", children: [
          ...
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-600", children: ((_a = page.template_type) == null ? void 0 : _a.name) || "Unknown" }) }),
...
function UserSitemapPage() {
  ...
  const filteredRoutes = routes.filter((route) => {
    var _a, _b;
    const searchLower = searchTerm.toLowerCase();
    const fromCity = ((_a = route.from_location.city) == null ? void 0 : _a.toLowerCase()) || "";
    const fromState = route.from_location.state.toLowerCase();
    const toCity = ((_b = route.to_location.city) == null ? void 0 : _b.toLowerCase()) || "";
